...
let nNetworkTrials = 1000; //number of trials during random walk
...
let actionArr, stimArr, switchRepeatArr, buffer, stimSet, trialIsRepeat, trialIsNA, switchType, accArr, stimTrialHistory = [], earlyReleaseExperiment = false, playSoundsExperiment = false;
let canvas, ctx, ntCanvas, ntCtx; //main and network walk canvas
...
$(document).ready(function(){
  ...
  // main display canvas
  canvas = document.getElementById('stimCanvas');
