...
*/
  switch (expStage){
    ...
    case "main1":
      switch (slideNum){
        case 1:
          return "You are now ready to start the main task. In the main task, you will follow the same procedure as in the final practice task. This task will last approximately 20 minutes. You will get periodic breaks about every 5 minutes.";
        case 2:
          $(imageTableDiv).insertAfter("#instructions" + slideNum);
    ...
    case "main3":
        switch (slideNum) {
          ...
          case 2:
            return "In this task, you will see an image from the repetition task appear on the screen. Next, a color word will appear superimposed on the image. For example, you might see the word 'RED' or 'BLUE'.";
          case 3:
